...
def main():
    ...
    st.write(
        "- Apakah ada perbedaan dalam rata-rata peminjaman sepeda pada hari libur dibandingkan dengan hari biasa?- Apakah terdapat perbedaan dalam pola peminjaman sepeda antara musim-musim tertentu?-  Bagaimana cuaca memengaruhi jumlah peminjaman sepeda?"
    )
