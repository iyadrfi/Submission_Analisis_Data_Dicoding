...
def main():
    ...
    # Display description for holiday data
    st.header("Description of Holiday Data")
    holiday_data = cleaned_data[
        (cleaned_data["workingday"] == 0) | (cleaned_data["holiday"] == 1)
    ]["cnt"]
    display_description(holiday_data)

    # Display description for workingday data
    st.header("Description of Workingday Data")
    workingday_data = cleaned_data[(cleaned_data["workingday"] == 1)]["cnt"]
    display_description(workingday_data)
