...
def main():
    ...
    st.header("Visualisasi Plot Bar Rata-rata Peminjaman Sepeda Menurut Tipe Hari")
    st.write(
    ...
    st.header(
        "Visualisasi Plot Bar Perbedaan Dalam Pola Peminjaman Sepeda Antara Musim-Musim Tertentu?"
    )
    st.write(
